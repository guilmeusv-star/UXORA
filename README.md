[README-4.md](https://github.com/user-attachments/files/26540804/README-4.md)
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8" />
  ...
  <div id="creations" class="creations-section">
    ...
    <div class="creation-grid">
      ...
      <div class="creation-card" data-category="fashion" data-index="4">
        ...
        ![image alt](https://github.com/guilmeusv-star/UXORA/blob/00bf3193a804803b8c490189bfe56be84d84be56/uxora-site/PHOTO-2026-02-25-13-31-46%203.jpg)
        <div class="card-overlay">
          <h3>Puma Lafrancé</h3>
